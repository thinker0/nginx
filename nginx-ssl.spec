...
#%{_libdir}/perl5/vendor_perl/auto/nginx.pm
#%{_libdir}/perl5/vendor_perl/auto/nginx/nginx.so
#%{_libdir}/perl5/vendor_perl/auto/nginx/nginx-debug.so
